          ...
          <form data-parsley-validate id="form-editor" method="POST" action="" enctype="multipart/form-data" class="form-horizontal form-label-left">
            ...
            <div class="form-group">
              <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                <button type="button" id="add-meta" class="btn btn-info" name="button">{{ __('product.update.add_meta') }}</button>
                <a class="btn btn-primary" href="{{ route('admin.products.index') }}" type="reset">@lang('common.cancel-btn')</a>
